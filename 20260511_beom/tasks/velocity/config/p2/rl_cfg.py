"""RL configuration for KIMM P2 velocity task."""
...
def kimm_p2_ppo_runner_cfg() -> RslRlOnPolicyRunnerCfg:
  """Create RL runner configuration for KIMM P2 velocity task."""
