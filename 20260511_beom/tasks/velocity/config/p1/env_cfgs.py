...
from mjlab.asset_zoo.robots.kimm_p1.kimm_p1_constants import P1ActuatorMode
...
def kimm_p1_rough_env_cfg(
  ...
  cfg.rewards["track_linear_velocity"].params["std_walking"] = math.sqrt(0.15)
  cfg.rewards["track_linear_velocity"].params["std_running"] = math.sqrt(0.3)
  ...
  cfg.rewards["foot_clearance"].weight = -5.0
  ...
  cfg.curriculum["track_angular_velocity_low_std"] = CurriculumTermCfg(
    ...
    params={
      ...
      "stages": [
        ...
        {"step": 2_500 * 24, "params": {"low_std": math.sqrt(0.25)}},
      ],
    },
  )
