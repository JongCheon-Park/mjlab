...
def make_tracking_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  rewards: dict[str, RewardTermCfg] = {
    ...
    "joint_torque_rate": RewardTermCfg(func=mdp.joint_torque_rate_l2, weight=-1.0e-5),
    "joint_effort_limit": RewardTermCfg(
      func=mdp.joint_effort_limits,
      weight=-1.0e-3,
      params={"soft_ratio": 0.7, "power": 2.0},
    ),
  }
...
def discriminator_obs(
  command_name: str = "motion",
  self_collision_sensor_name: str = "self_collision_detailed",
) -> dict[str, ObservationTermCfg]:
  """Create common discriminator observation terms."""
  return {
    "anchor_pos_error": ObservationTermCfg(
      func=mdp.motion_global_anchor_position_error,
      params={"command_name": command_name},
    ),
    "anchor_ori_error": ObservationTermCfg(
      func=mdp.motion_global_anchor_orientation_error,
      params={"command_name": command_name, "representation": "6d"},
    ),
    "body_pos_error": ObservationTermCfg(
      func=mdp.motion_relative_body_position_error,
      params={"command_name": command_name},
    ),
    "body_ori_error": ObservationTermCfg(
      func=mdp.motion_relative_body_orientation_error,
      params={"command_name": command_name, "representation": "6d"},
    ),
    "body_lin_vel_error": ObservationTermCfg(
      func=mdp.motion_global_body_lin_vel_error,
      params={"command_name": command_name},
    ),
    "body_ang_vel_error": ObservationTermCfg(
      func=mdp.motion_global_body_ang_vel_error,
      params={"command_name": command_name},
    ),
    "self_collision": ObservationTermCfg(
      func=mdp.self_collision_slack,
      params={"sensor_name": self_collision_sensor_name},
    ),
    "action_rate": ObservationTermCfg(
      func=mdp.action_rate_slack,
      params={"threshold": 0.5},
    ),
    "joint_limit": ObservationTermCfg(
      func=mdp.joint_limit_slack,
      params={"asset_cfg": SceneEntityCfg("robot", joint_names=(".*",))},
    ),
    "torque_limit": ObservationTermCfg(
      func=mdp.torque_limit_slack,
      params={
        "asset_cfg": SceneEntityCfg("robot", actuator_names=(".*",)),
        "soft_ratio": 0.9,
      },
    ),
    "torque_rate": ObservationTermCfg(
      func=mdp.torque_rate_slack,
      params={
        "asset_cfg": SceneEntityCfg("robot", actuator_names=(".*",)),
        "threshold": 0.5,
      },
