"""RL configuration for KIMM P1 tracking task."""
...
def kimm_p1_tracking_ppo_runner_cfg() -> RslRlOnPolicyRunnerCfg:
  """Create RL runner configuration for KIMM P1 tracking task."""
...
def kimm_p1_tracking_add_runner_cfg() -> RslRlOnPolicyRunnerCfg:
  """Create RL runner configuration for P1 Tracking-ADD task."""
  return RslRlOnPolicyRunnerCfg(
    actor=RslRlModelCfg(
      hidden_dims=(512, 256, 128),
      activation="elu",
    ...
    experiment_name="p1_tracking_add",
    save_interval=500,
    num_steps_per_env=24,
    max_iterations=30_000,
    obs_groups={
