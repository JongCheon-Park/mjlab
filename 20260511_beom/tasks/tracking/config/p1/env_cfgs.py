"""KIMM P1 flat tracking environment configurations."""
...
def kimm_p1_flat_tracking_env_cfg(
  has_state_estimation: bool = False,
  play: bool = False,
) -> ManagerBasedRlEnvCfg:
  """Create KIMM P1 flat terrain tracking configuration."""
  ...
  # PD gains randomization: P1 has 5 actuator groups
...
def kimm_p1_tracking_add_env_cfg(
  play: bool = False,
  has_state_estimation: bool = False,
) -> ManagerBasedRlEnvCfg:
  """Configuration for P1 Tracking-ADD task with discriminator observations."""

  # 1. Reuse Flat Tracking Config
  cfg = kimm_p1_flat_tracking_env_cfg(
    play=play,
